...
export default function Header({ servers, alerts, connected }) {
  ...
  return (
    <header style={{ borderBottom:`1px solid ${C.border}`, padding:"0 28px",
      display:"flex", alignItems:"center", justifyContent:"space-between",
      height:58, background:`${C.panel}DD`, backdropFilter:"blur(12px)",
      ...
      <div style={{ display:"flex", alignItems:"center", gap:14 }}>
        ...
        <div>
          <div style={{ fontWeight:800,fontSize:17,letterSpacing:1,fontFamily:"'Syne',sans-serif" }}>
            NEXUS<span style={{ color:C.accent }}>PULSE</span>
          </div>
          <div style={{ fontFamily:"'Space Mono',monospace",fontSize:9,color:C.dim,letterSpacing:2 }}>
            SMART SERVER MONITORING & ALERT SYSTEM
          </div>
        </div>
      </div>
      <div style={{ display:"flex", alignItems:"center", gap:18 }}>
        <div style={{ textAlign:"center" }}>
          <div style={{ fontFamily:"'Space Mono',monospace",fontSize:22,fontWeight:700,color:healthColor(100-sysHealth) }}>
